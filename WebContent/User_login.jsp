    ...
    <img alt="im a ad" id="login_nav" src="css/images/sunshine_min.png" />
        ...
        <div class="login">
            <div class="container offset1 loginform">
                ...
                <div class="form-actions"><a href="find_pwd.jsp" tabindex="5" class="btn pull-left btn-link text-muted">忘记密码?</a><a href="register.jsp" tabindex="6" class="btn btn-link text-muted">注册</a>
                    <button  tabindex="4" class="btn btn-primary" id="login_btn">登录</button>
                </div>
            </div>
        </div>
    </div>
