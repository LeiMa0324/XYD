...
<script src="${pageContext.request.contextPath}/js/modify-userpwd.js" type="text/javascript"></script>
				...
				<div class="row-fluid">
					...
					<div class="form-horizontal">
						<div class="control-group">
							<label class="control-label" for="oldPassword" contenteditable="false">原密码</label>
							<div class="controls">
								<input id="OldPassword" placeholder="请输入原密码" type="password" />
							</div>
						
						</div>
						<div class="control-group">
							<label class="control-label" for="inputNewPassword" contenteditable="false">新密码</label>						
							<div class="controls">
								<input id="NewPassword" placeholder="请输入新密码" type="password" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="confirmNewPassword" contenteditable="false">确认密码</label>
							<div class="controls">
								<input id="NewPassword_re" placeholder="再次输入新密码" type="password" />
							</div>
						</div>
						<br>	
						<div class="control-group">
                   			 <div class="controls">
								<button type="button" class="btn " id="modifypwd_btn">确认修改</button>
							</div>
						</div>
					</div>
					</div>
