...
<script src="${pageContext.request.contextPath}/js/shop_login.js" type="text/javascript"></script>
    ...
    <img alt="im a ad" id="login_nav" src="css/images/sunshine_min.png" />
        ...
        <div class="login">
            <div class="container offset1 loginform">
                ...
                <div class="pad">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <input id="account"  name="account" placeholder="账号" tabindex="1" autofocus="autofocus" class="form-control input-medium">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
                ...
                <div class="form-actions"><a href="Shop_register.jsp" tabindex="6" class="btn btn-link text-muted">商户注册</a>
                    <button  tabindex="4" class="btn btn-primary" id="login_btn">商户登录</button>
                </div>
            </div>
        </div>
    </div>
